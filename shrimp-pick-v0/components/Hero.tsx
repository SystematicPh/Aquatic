...
export function Hero({ signedIn }: HeroProps) {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "linear-gradient(135deg, rgba(13,27,30,0.68), rgba(27,73,101,0.42)), url('https://images.unsplash.com/photo-1520301255226-bf5f144451c1?auto=format&fit=crop&w=1600&q=80')"
      }}
    >
      <div className="max-w-3xl">
        <p className="mb-4 text-sm uppercase tracking-[0.35em] text-white/75">Ornamental aquarium fish store</p>
        <h1 className="font-display text-5xl font-semibold tracking-tight sm:text-6xl">Aquatic Shop</h1>
